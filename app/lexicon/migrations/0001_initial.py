    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "word",
                    models.CharField(max_length=128, unique=True, verbose_name="Word"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lang",
                    models.CharField(
                        choices=[("ru", "Hormiksi"), ("fi", "Šuomekši")], max_length=32
                    ),
                ),
                ...
                (
                    "word",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="lexicon.Word"
                    ),
                ),
            ],
            options={
